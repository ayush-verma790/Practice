...
export default function Home() {
  return (
    <main>
      <div className='w-[100%] mx-auto grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 gap-4 p-[2%]'>
        ...
        <div className='bg-blue-400 p-[4%] col-span-full lg:col-start-2 lg:col-end-6 sm:col-span-1'>
           Hello 6
        </div>
